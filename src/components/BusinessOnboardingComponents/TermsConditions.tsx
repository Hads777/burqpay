        ...
        >
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ marginBottom: "12px" }}>
              Welcome to MYPAY's business services provided by MYTM. These Terms &
              Conditions govern your use of our business services. By accessing or using
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ marginBottom: "12px" }}>
              This Business Service Agreement constitutes a legally binding agreement
              between your business and MYTM. By using MYPAY business services, you acknowledge
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ marginBottom: "12px" }}>
              To access certain features of our business services, you may be required to
              register for a business account. You agree to provide accurate, current,
              and complete business information during the registration process and to
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ marginBottom: "12px" }}>
              You agree to use our business services only for lawful purposes and in
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ marginBottom: "12px" }}>
              We may terminate or suspend your business account and access to the
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ marginBottom: "12px" }}>
              Your use of our business services is also governed by our Privacy Policy.
              Please review our Privacy Policy to understand our practices
              regarding the collection and use of your business information.
            </p>
          </div>
        </div>
