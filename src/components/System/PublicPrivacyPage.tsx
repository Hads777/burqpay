  ...
  return (
    <div className="service">
      ...
      <div className="container-fluid">
        ...
        {/* <div className="inner_banner_new parallex" >f</div>  */}
        <div className="inner_banner_box_parent">
    <div className="container">
      <div className="inner_banner_box">
        <h2><div dir="auto" style={{verticalAlign:"inherit"}}><div dir="auto" style={{verticalAlign:"inherit"}}>privacy policy</div></div></h2>
        <p><div dir="auto" style={{verticalAlign:"inherit"}}><div dir="auto" style={{verticalAlign:"inherit"}}>This Privacy Notice describes how Flexible Murabaha  (hereinafter referred to as)</div></div></p>
      </div>
