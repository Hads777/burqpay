  ...
  return (
    <>
      ...
      <Modal
        ...
        title = {key == "add" ? "Add New Campaign": "Edit Campaign"}
        open={modal}
          ...
          <Form layout="vertical">
            <div className="row p-2 mt-4">
                ...
                <div className="form-group flex-column-reverse align-items-lg-start">
                  ...
                  <label style={{ color: "#666666" }}>Upload Image</label>
                  {formData.logo && (
              ...
              <div className="col-6 mb-3">
                <div className="form-group align-items-start flex-column">
                    <p style={{ margin: 0, fontWeight: 600, color: "#181717", fontSize: 17 }}>
                    Status
                  </p>
                  <Switch/>     
                </div>
              ...
              <div className="col-12 mb-3">
                <div className="form-group form-label-group align-items-start flex-column">
                  ...
                  <label style={{ color: "#666666" }}>Redirect URL</label>
                </div>
              </div>              
            </div>
          </Form>
